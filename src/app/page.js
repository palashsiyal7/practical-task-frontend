      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="flex gap-x-4">
            ...
            <Link
              href="/auth/register"
              className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-indigo-600 border border-indigo-600 shadow-sm hover:bg-indigo-50"
            >
              Register
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Role-Based Dashboard with Real-Time Notifications
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              A secure platform with user authentication, role-based access control, and real-time alerts. Perfect for teams that need to collaborate with different permission levels.
            </p>
